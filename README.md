...
|---:|---|---|---|
| 1 | ECG Image-to-Signal Reconstruction | Medical AI, computer vision, signal reconstruction | [medical-ecg-image-to-signal-reconstruction-pipeline](https://github.com/ezedeem223/medical-ecg-image-to-signal-reconstruction-pipeline) |
| 2 | Satellite Land Classification with CNN/CNN-ViT | Remote sensing and comparative vision architectures | [satellite-land-classification-cnn-vit](https://github.com/ezedeem223/satellite-land-classification-cnn-vit) |
| 3 | Waste Classification using VGG16 Transfer Learning | Sustainability-focused image classification and model release | [waste-classification-transfer-learning](https://github.com/ezedeem223/waste-classification-transfer-learning) |
| 4 | Aircraft Damage Classification + BLIP Reports | Inspection-support computer vision and vision-language workflow | [aircraft_damage_vgg16_blip](https://github.com/ezedeem223/aircraft_damage_vgg16_blip) |
| 5 | Rainfall Prediction in Australia | Tabular ML, metric provenance, and environmental prediction | [rainfall-prediction-classifier](https://github.com/ezedeem223/rainfall-prediction-classifier) |
